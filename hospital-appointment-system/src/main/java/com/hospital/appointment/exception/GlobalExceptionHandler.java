...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ApiExceptions.SlotConflictException.class)
    public ResponseEntity<Map<String, Object>> handleSlotConflict(ApiExceptions.SlotConflictException ex) {
